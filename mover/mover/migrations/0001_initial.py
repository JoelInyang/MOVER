    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(blank=True, choices=[('driver', 'Driver'), ('customer', 'Customer')], max_length=10, null=True)),
                ...
                ('rate_of_service', models.CharField(blank=True, choices=[('FX', 'Fixed'), ('HR', 'Hourly')], max_length=100, null=True)),
                ('hourly_amount', models.IntegerField(blank=True, null=True)),
                ...
                ('license_state', models.CharField(blank=True, max_length=200, null=True)),
                ('license_zipcode', models.CharField(blank=True, max_length=200, null=True)),
